...
| `documentation/requirements/user-requirements.md` | Unapproved | — |
| `documentation/requirements/phase-1-user-stories.md` | Unapproved | — |
| `documentation/decisions/architecture-decisions.md` | Unapproved | — |
| `documentation/project/architecture.md` | Unapproved | — |
| `documentation/tasks/api-contract.md` | Unapproved | — |
| `documentation/tasks/senior-developer-backend-plan.md` | Unapproved | — |
| `documentation/tasks/senior-developer-frontend-plan.md` | Unapproved | — |
| `documentation/tasks/backend-tasks.md` | Unapproved | — |
| `documentation/tasks/frontend-tasks.md` | Unapproved | — |
...
```text
2026/04/08 10:00 - overview.md approved - Developer - reviewed and confirmed
2026/04/08 11:30 - overview.md unapproved - Head of Development - clarification on Mentor memory required
2026/04/08 12:00 - overview.md approved - Developer - Mentor memory section clarified
2026/04/08 12:01 - user-requirements.md unapproved - Product Owner - cascade from overview.md change
```
...
Documents have a dependency chain. A downstream document cannot be approved until all upstream documents it depends on are approved.
        ...
        └── documentation/requirements/phase-1-user-stories.md
              └── documentation/decisions/architecture-decisions.md
                    └── documentation/project/architecture.md
                          └── documentation/tasks/api-requirements-frontend.md
                                └── documentation/tasks/api-contract.md
...
2. Not proceed with work that depends on the challenged document until it is re-approved

The Product Owner owns the unapproval cascade for documents it produced. For architecture documents, the Head of Development owns the cascade.
